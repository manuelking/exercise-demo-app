...
const ExerciseDetail = () => {
  ...
  const [equipmentExercies, setEquipmentExercises] = useState([]);
  const { id } = useParams();
  ...
  return (
    <Box>
      ...
      <SimilarExercises targetMuscleExercises={targetMuscleExercises} equipmentExercies={equipmentExercies} />
    </Box>
  )
}
